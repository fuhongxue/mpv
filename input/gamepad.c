...
static const int button_map[][2] = {
    { SDL_CONTROLLER_BUTTON_A, MP_KEY_GAMEPAD_CROSS },
    { SDL_CONTROLLER_BUTTON_B, MP_KEY_GAMEPAD_CIRCLE },
    { SDL_CONTROLLER_BUTTON_X, MP_KEY_GAMEPAD_SQUARE },
    { SDL_CONTROLLER_BUTTON_Y,  MP_KEY_GAMEPAD_TRIANGLE },
    ...
    { SDL_CONTROLLER_BUTTON_LEFTSTICK, MP_KEY_GAMEPAD_L3 },
    { SDL_CONTROLLER_BUTTON_RIGHTSTICK, MP_KEY_GAMEPAD_R3 },
    { SDL_CONTROLLER_BUTTON_LEFTSHOULDER, MP_KEY_GAMEPAD_L1 },
    { SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, MP_KEY_GAMEPAD_R1 },
...
static const int axis_map[][4] = {
    ...
    { SDL_CONTROLLER_AXIS_TRIGGERLEFT,
        INVALID_KEY,
        MP_KEY_GAMEPAD_L2 | MP_KEY_STATE_UP,
        MP_KEY_GAMEPAD_L2 | MP_KEY_STATE_DOWN },

    { SDL_CONTROLLER_AXIS_TRIGGERRIGHT,
        INVALID_KEY,
        MP_KEY_GAMEPAD_R2 | MP_KEY_STATE_UP,
        MP_KEY_GAMEPAD_R2 | MP_KEY_STATE_DOWN },
};

static int lookup_button_mp_key(int sdl_key) {
    for (int i = 0; MP_ARRAY_SIZE(button_map); i++) {
...
static int lookup_axis_mp_key(int sdl_key, int16_t value) {
    ...
    const int state =
        value >= sdl_axis_max - threshold ?
        positive :
            value <= threshold - sdl_axis_max ?
            negative : neutral;

    for (int i = 0; MP_ARRAY_SIZE(axis_map); i++) {

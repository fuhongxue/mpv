...
static const struct key_name key_names[] = {
  ...
  { MP_KEY_GAMEPAD_CROSS, "GAMEPAD_CROSS" },
  { MP_KEY_GAMEPAD_CIRCLE, "GAMEPAD_CIRCLE" },
  { MP_KEY_GAMEPAD_SQUARE, "GAMEPAD_SQUARE" },
  { MP_KEY_GAMEPAD_TRIANGLE, "GAMEPAD_TRIANGLE" },
  { MP_KEY_GAMEPAD_BACK, "GAMEPAD_BACK" },
  { MP_KEY_GAMEPAD_MENU, "GAMEPAD_MENU" },
  { MP_KEY_GAMEPAD_START, "GAMEPAD_START" },
  { MP_KEY_GAMEPAD_L1, "GAMEPAD_L1" },
  { MP_KEY_GAMEPAD_R1, "GAMEPAD_R1" },
  { MP_KEY_GAMEPAD_L2, "GAMEPAD_L2" },
  { MP_KEY_GAMEPAD_R2, "GAMEPAD_R2" },
  { MP_KEY_GAMEPAD_L3, "GAMEPAD_L3" },
  { MP_KEY_GAMEPAD_R3, "GAMEPAD_R3" },

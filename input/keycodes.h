...
#define MP_KEY_GAMEPAD_CROSS              (MP_KEY_GAMEPAD+0)
#define MP_KEY_GAMEPAD_CIRCLE             (MP_KEY_GAMEPAD+1)
#define MP_KEY_GAMEPAD_SQUARE             (MP_KEY_GAMEPAD+2)
#define MP_KEY_GAMEPAD_TRIANGLE           (MP_KEY_GAMEPAD+3)
...
#define MP_KEY_GAMEPAD_L1                 (MP_KEY_GAMEPAD+7)
#define MP_KEY_GAMEPAD_R1                 (MP_KEY_GAMEPAD+8)
#define MP_KEY_GAMEPAD_L2                 (MP_KEY_GAMEPAD+9)
#define MP_KEY_GAMEPAD_R2                 (MP_KEY_GAMEPAD+10)
#define MP_KEY_GAMEPAD_L3                 (MP_KEY_GAMEPAD+11)
#define MP_KEY_GAMEPAD_R3                 (MP_KEY_GAMEPAD+12)
